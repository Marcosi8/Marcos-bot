...
( *OBS: O SIMI ESTÁ TOTALMENTE EM INDONÉSIO* )
 ...
 ☾ 𝙾𝚄𝚃𝚁𝙾𝚂 𝙲𝙾𝙼𝙰ndos 
   ...
   ┠➠ *${prefix}clone 
   ╿𝘜𝘵𝘪𝘭𝘪𝘥𝘢𝘥𝘦: Colocaa foto do usuário mencionado como foto de perfil do bot
   ╿𝘌𝘹𝘦𝘮𝘱𝘭𝘰: ${prefix}clone e o @ do usuário
   ...
   ┠➠ *${prefix}wait*
   ╿𝘜𝘵𝘪𝘭𝘪𝘥𝘢𝘥𝘦: Procura o anime da foto que você enviar!
   ╿𝘌𝘹𝘦𝘮𝘱𝘭𝘰: Mande a foto do anime (ou responda) com a legenda .wait
...
*Segue no ig:* @marcoskz_ ☄️(https://instagram.com/marcoskz_)
